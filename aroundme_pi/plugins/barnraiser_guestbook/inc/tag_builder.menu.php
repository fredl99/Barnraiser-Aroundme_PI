...
<ul>
	<li><a href="#tag_builder" onclick="javascript:loadPluginTagBuilder('plugins/barnraiser_guestbook/block_tag_builder.php?tag=list');">Create a wall</a></li>
</ul>


<script type="text/javascript">

function buildPluginBarnaiserGuestbookTag(name) {
	tag = '<AM_BLOCK plugin="barnraiser_guestbook" name="'+name+'" ';
